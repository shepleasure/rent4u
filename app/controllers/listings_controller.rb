class ListingsController < ApplicationController
	...
	def listing_params
		params.require(:listing).permit(:title, :description, :city, :locality, :category_id, :subcategory_id, listing_attachments_attributes: [:id, :avatar, :avatar_cache, :_destroy])
	end
